...
export function ViewerShell({ initialState }: ViewerShellProps) {
  ...
  const scopeStageProjectedMarkerObjects: ScopeProjectedSkyObject[] = scopeProjectedMarkerObjects
    .map((object) => ({
      ...object,
  ...
  const scopeVisibleMarkerObjects: ScopeProjectedSkyObject[] = scopeStageProjectedMarkerObjects
  ...
  const selectedObject = resolveInteractionSummaryObject(
    ...
    selectedObjectInteractionSurface,
    {
      ...
      scopeAllObjects: scopeStageProjectedMarkerObjects,
